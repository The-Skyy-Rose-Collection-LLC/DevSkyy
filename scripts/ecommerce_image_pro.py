    ...
    def upscale_image(self, image_path: Path, scale: int = 4) -> Path | None:
        ...
        try:
            ...
            if hasattr(output, "read"):
                ...
                urllib.request.urlretrieve(str(output), upscaled_path)  # nosec B310 — URL from controlled API response, not user input
    ...
    def remove_background(self, image_path: Path) -> Path | None:
        ...
        try:
            ...
            if hasattr(output, "read"):
                ...
                urllib.request.urlretrieve(str(output), nobg_path)  # nosec B310 — URL from controlled API response, not user input
