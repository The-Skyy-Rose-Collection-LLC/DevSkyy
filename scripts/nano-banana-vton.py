...
# LOGO_TREATMENTS imported from nano_banana.prompts (single source of truth).
# See scripts/nano_banana/prompts.py for the authoritative dict.
import sys as _sys
from pathlib import Path as _Path
_sys.path.insert(0, str(_Path(__file__).resolve().parent))
from nano_banana.prompts import LOGO_TREATMENTS  # noqa: E402
