    ...
    try:
        ...
        if task.status == TaskStatus.SUCCESS:
            ...
            try:
                ...
                if downloaded_files and "model_mesh" in downloaded_files:
                    model_path = downloaded_files["model_mesh"]
...
async def main() -> None:
    ...
    if not images_by_collection:
        ...
        logger.info("Please ensure images are extracted to assets/extracted/{COLLECTION}/")
        return
