...
def test_imports():
    ...
    try:
        from api.index import app, handler, handler_func  # noqa: F401

        print("✅ API index imports successful")

        from main_enterprise import app as main_app  # noqa: F401
...
def main():
    ...
    tests = [test_imports, test_app_creation, test_handler, test_vercel_config]
