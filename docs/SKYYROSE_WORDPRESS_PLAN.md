...
| 4. Premium aesthetic triangulation | Pick three real luxury brands (e.g., The Row, Aimé Leon Dore, Rick Owens, Bottega, Khaite) whose digital presence solves what we're trying to solve. Describe what they do that we don't. | Named brands, named pages, named techniques. Not "high-end brands use whitespace" — specifically how they use it on a specific page. |
...
1. **The $3,000 jacket buyer.** They've worn The Row, Bode, Khaite. They are price-insensitive but taste-strict. Where does this page meet them? Where does it fall short?
