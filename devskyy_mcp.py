...
class FixCodeInput(BaseAgentInput):
    ...
    fix_types: Optional[List[str]] = Field(
...
async def _make_api_request(
    ...
    try:
        ...
        return {"error": "Request timed out. The DevSkyy API may be overloaded. Try again in a moment."}
...
async def ml_prediction(params: MLPredictionInput) -> str:
    ...
    return _format_response(data, params.response_format, f"ML Prediction: {params.model_type.value}")
