...
class SecurityMiddleware(BaseHTTPMiddleware):
    ...
    async def _security_violation_response(self, request_id: str, client_ip: str, 
                                         threat_type: str, message: str) -> JSONResponse:
    ...
    async def _log_request(self, request: Request, response: Response, 
                          request_id: str, client_ip: str, processing_time: float):
