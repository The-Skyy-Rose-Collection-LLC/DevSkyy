...
async def list_all_agents(current_user: TokenData = Depends(get_current_active_user)):
    ...
    agents = {
        "core": [
            {"name": "Scanner", "endpoint": "/agents/scanner/execute", "category": "core"},
            {"name": "Scanner V2", "endpoint": "/agents/scanner-v2/execute", "category": "core"},
            {"name": "Fixer", "endpoint": "/agents/fixer/execute", "category": "core"},
            {"name": "Fixer V2", "endpoint": "/agents/fixer-v2/execute", "category": "core"},
            {"name": "Security", "endpoint": "/agents/security/execute", "category": "core"},
            {"name": "Performance", "endpoint": "/agents/performance/execute", "category": "core"},
        ],
        "ai": [
            {"name": "Claude Sonnet", "endpoint": "/agents/claude-sonnet/execute", "category": "ai"},
            {"name": "OpenAI", "endpoint": "/agents/openai/execute", "category": "ai"},
            {"name": "Multi-Model AI", "endpoint": "/agents/multi-model-ai/execute", "category": "ai"},
        ],
        "ecommerce": [
            {"name": "E-commerce", "endpoint": "/agents/ecommerce/execute", "category": "ecommerce"},
            {"name": "Inventory", "endpoint": "/agents/inventory/execute", "category": "ecommerce"},
            {"name": "Financial", "endpoint": "/agents/financial/execute", "category": "ecommerce"},
        ],
        "marketing": [
            {"name": "Brand Intelligence", "endpoint": "/agents/brand-intelligence/execute", "category": "marketing"},
            {"name": "SEO Marketing", "endpoint": "/agents/seo-marketing/execute", "category": "marketing"},
            {"name": "Social Media", "endpoint": "/agents/social-media/execute", "category": "marketing"},
            {"name": "Email/SMS", "endpoint": "/agents/email-sms/execute", "category": "marketing"},
            {"name": "Marketing Content", "endpoint": "/agents/marketing-content/execute", "category": "marketing"},
        ],
        "wordpress": [
            {"name": "WordPress", "endpoint": "/agents/wordpress/execute", "category": "wordpress"},
            {"name": "Theme Builder", "endpoint": "/agents/wordpress-theme-builder/execute", "category": "wordpress"},
        ],
        "customer": [
            {"name": "Customer Service", "endpoint": "/agents/customer-service/execute", "category": "customer"},
            {"name": "Voice/Audio", "endpoint": "/agents/voice-audio/execute", "category": "customer"},
        ],
        "advanced": [
            {"name": "Blockchain/NFT", "endpoint": "/agents/blockchain-nft/execute", "category": "advanced"},
            {"name": "Code Generation", "endpoint": "/agents/code-generation/execute", "category": "advanced"},
        ],
    }
