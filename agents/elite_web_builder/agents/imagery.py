...
IMAGERY_SPEC = AgentSpec(
    ...
    system_prompt=(
        ...
        "point at the new file, then regenerate sot.json "
        "(build-collection-sot.py) — other systems (dashboard, theme) "
        "discover renders via skyyrose.core.sot_images.resolve_image(), "
