...
class RoleDefinition:
    ...
    nickname: str | None = None  # e.g., "The Code Whisperer"
...
class FewShotExample:
    ...
    input_text: str
    output_text: str
    reasoning: str | None = None  # For CoT few-shot
...
class PromptTechniqueEngine:
    ...
    def build_prompt(
        ...
        thought_branches: list[ThoughtBranch] | None = None,
    ...
    def _build_chain_of_thought(self, task: str, **kwargs) -> str:
        """
...
Think step by step. Let's work through this carefully."""
    ...
    def _build_few_shot(
        self, task: str, few_shot_examples: list[FewShotExample] | None = None, **kwargs
    ) -> str:
        """
    ...
    def _build_self_consistency(self, task: str, num_paths: int = 3, **kwargs) -> str:
        """
...
""")
    ...
    def _build_react(self, task: str, available_tools: list[str] | None = None, **kwargs) -> str:
        """
...
Start with your first Thought about this task."""
    ...
    def _build_rag(self, task: str, rag_context: str | None = None, **kwargs) -> str:
        """
...
- LOW: From general knowledge (flag as such)"""
    ...
    def _build_prompt_chaining(
        self, task: str, chain_steps: list[str] | None = None, **kwargs
    ) -> str:
        """
...
- Final output must synthesize all phase results""")
    ...
    def _build_generated_knowledge(
        self, task: str, knowledge_domains: list[str] | None = None, **kwargs
    ) -> str:
        """
...
Ensure your answer reflects this expertise."""
    ...
    def _build_negative_prompting(
        self, task: str, negative_examples: list[str] | None = None, **kwargs
    ) -> str:
        """
    ...
    def _build_constitutional(
        self, task: str, constitutional_principles: list[str] | None = None, **kwargs
    ) -> str:
        """
...
If any answer is concerning, revise the response accordingly."""
    ...
    def get_technique_description(self, technique: PromptTechnique) -> str:
        ...
        descriptions = {
            PromptTechnique.ROLE_BASED_CONSTRAINT: "Assigns expert role with quantified experience and specific constraints",
            PromptTechnique.CHAIN_OF_THOUGHT: "Forces step-by-step reasoning before conclusion (17.7% → 78.7% on math)",
            PromptTechnique.FEW_SHOT: "Provides examples to learn from (3-5 examples optimal)",
            PromptTechnique.SELF_CONSISTENCY: "Generates multiple paths, selects most consistent answer",
            PromptTechnique.TREE_OF_THOUGHTS: "Explores multiple approaches, evaluates each, selects best",
            PromptTechnique.REACT: "Interleaves reasoning with tool/action calls",
            PromptTechnique.RAG: "Grounds generation in retrieved factual context",
            PromptTechnique.PROMPT_CHAINING: "Breaks task into sequential phases",
            PromptTechnique.GENERATED_KNOWLEDGE: "Primes model with self-generated domain knowledge",
            PromptTechnique.NEGATIVE_PROMPTING: "Explicitly states what NOT to do",
            PromptTechnique.CONSTITUTIONAL_AI: "Embeds ethical principles and self-critique",
        }
...
def create_agent_prompt(
    ...
    techniques = engine.auto_select_techniques(task=task, complexity=complexity)
