...
class AgentPromptLibrary:
    ...
    def get_agents_by_category(self, category: AgentCategory) -> list[str]:
        ...
        return [name for name, config in self._agent_configs.items() if config.category == category]

    def get_agent_config(self, agent_name: str) -> AgentPromptConfig | None:
...
def get_agent_prompt(agent_name: str, task: str | None = None) -> str:
    """
