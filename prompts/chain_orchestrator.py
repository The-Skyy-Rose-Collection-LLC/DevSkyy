...
class ChainStep:
    ...
    )  # Maps previous outputs to this step's inputs
...
class WorkflowDefinition:
    ...
    final_aggregation: str | None = None  # How to combine results
        ...
        workflows["product_launch"] = WorkflowDefinition(
            ...
            steps=[
                ...
                ChainStep(
                    ...
                    input_mapping={"analysis": "analyze.output", "pricing": "price.output"},
                ),
                ChainStep(
                    step_id="seo",
                ...
                ChainStep(
                    ...
                    input_mapping={"content": "describe.output", "seo": "seo.output"},
                ),
            ],
        ...
        workflows["content_pipeline"] = WorkflowDefinition(
            ...
            steps=[
                ...
                ChainStep(
                    ...
                    input_mapping={"content": "write.output", "seo": "optimize.output"},
                ),
            ],
        )
...
```json
{json.dumps(self._resolve_input_mapping(step.input_mapping, context), indent=2)}
```
