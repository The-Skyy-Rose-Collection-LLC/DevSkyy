...
class BehavioralDirective:
    ...
    def to_prompt_line(self) -> str:
        ...
        type_emoji = {"always": "✓", "never": "✗", "prefer": "→", "avoid": "⊘"}
...
""",
    ...
    def generate(
        ...
        custom_directives: list[BehavioralDirective] | None = None,
        custom_objective: str | None = None,
        custom_response_format: str | None = None,
        operational_parameters: dict[str, Any] | None = None,
    ) -> str:
        """
...
- Error handling"""
    ...
    def _format_operational_parameters(
        self, params: dict[str, Any], identity: AgentIdentity
    ) -> str:
