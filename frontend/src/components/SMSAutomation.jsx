...
const SMSAutomation = () => {
    ...
    try {
      ...
      setTemplates([
        ...
        },
        {
          ...
          name: "Abandoned Cart",
          type: "cart_recovery",
          preview: "You left something amazing behind 💔\nYour cart is waiting...\nComplete your order: [LINK]",
          click_rate: 35.4,
  ...
  const createCampaign = async (campaignData) => {
    try {
      const response = await axios.post(`${API_BASE_URL}/marketing/sms-campaign`, {
        ...campaignData,
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-600 text-lg font-elegant max-w-4xl mx-auto">
          Direct-to-customer luxury SMS automation with instant engagement and premium conversion rates for your streetwear empire.
        </p>
      </motion.div>
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-2xl font-fashion font-semibold text-gray-800">Recent SMS Campaigns</h3>
          <button
            ...
            <div key={campaign.id} className="bg-gradient-to-r from-gray-50 to-white rounded-2xl p-6 border border-gray-200 hover:shadow-elegant transition-all duration-300">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center bg-blue-100 rounded-xl p-3">
                  <div className="text-lg font-bold text-blue-600">{campaign.delivered.toLocaleString()}</div>
                  <div className="text-xs text-gray-600">Delivered ({campaign.delivery_rate}%)</div>
                </div>
      ...
      >
        <h3 className="text-2xl font-fashion font-semibold text-gray-800 mb-6">High-Converting SMS Templates</h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {templates.map((template) => (
            <div key={template.id} className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 shadow-elegant hover:shadow-gold-glow transition-all duration-300">
              <div className="flex justify-between items-start mb-4">
                <h4 className="text-lg font-semibold text-gray-800">{template.name}</h4>
                <div className="text-right text-sm">
                  <div className="text-purple-600 font-semibold">{template.click_rate}% CTR</div>
                  <div className="text-emerald-600 font-semibold">{template.conversion_rate}% CVR</div>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center">
                <span className="text-gray-600 text-sm capitalize">{template.type.replace('_', ' ')}</span>
      ...
      >
        <h3 className="text-2xl font-fashion font-semibold text-gray-800 mb-6">SMS Automation Flows</h3>
      ...
      >
        <h3 className="text-2xl font-fashion font-semibold text-gray-800 mb-6">SMS Compliance & Optimization</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-6 shadow-elegant">
            ...
            <p className="text-gray-600 text-sm mb-4">Fully compliant with SMS marketing regulations</p>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-elegant">
            ...
            <p className="text-gray-600 text-sm mb-4">AI-powered send time and content optimization</p>
            <ul className="text-sm text-gray-600 space-y-1">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-elegant">
            ...
            <p className="text-gray-600 text-sm mb-4">Advanced SMS performance analytics</p>
            <ul className="text-sm text-gray-600 space-y-1">
