  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      ...
      <div className="text-center mb-8">
        ...
        >
          Your squad of animated AI agents working 24/7 to dominate the fashion
          world. Each guru brings unique streetwear style and GOD MODE
          intelligence.
        </motion.p>
      </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-4 hover:bg-gray-800/70 transition-all duration-300">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span
                      className={`text-sm font-bold ${getPowerLevelColor(agentData.power_level)}`}
                    >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-green-400">
                {Object.values(agents).reduce(
                  (sum, agent) => sum + agent.completed_today,
                  0
                )}
              </div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-400">
                {Math.round(
                  Object.values(agents).reduce(
                    (sum, agent) => sum + agent.power_level,
                    0
                  ) / Object.values(agents).length
                )}
                %
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    {agents[selectedAgent]?.last_achievement}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    {agents[selectedAgent]?.current_project}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm capitalize">
                    {agents[selectedAgent]?.expertise_focus?.replace('_', ' ')}
                  </p>
                </div>
