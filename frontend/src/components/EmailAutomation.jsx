    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-600 text-lg font-elegant max-w-4xl mx-auto">
          Luxury email automation that converts streetwear enthusiasts into
          loyal customers with AI-powered personalization and premium design.
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {templates.map(template => (
            <div
              key={template.id}
              className="bg-gradient-to-br from-gray-50 to-white rounded-2xl overflow-hidden shadow-elegant hover:shadow-gold-glow transition-all duration-300"
            >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {Object.entries(subscribers.segments).map(([segment, count]) => (
            <div
              key={segment}
              className="bg-white rounded-2xl p-4 shadow-elegant text-center"
            >
