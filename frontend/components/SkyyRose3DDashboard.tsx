/**
 * SkyyRose 3D Asset Pipeline Dashboard
 * =====================================
 * Premium UI for 3D asset generation with particle effects,
 * glass morphism, and real-time pipeline visualization.
 */
  ...
  <div className={`relative group overflow-hidden rounded-2xl p-4 transition-all duration-500 hover:scale-[1.02] ${
    ...
    <div className="relative">
      ...
      <div className="flex items-baseline gap-1">
        <span className={`text-3xl font-light tracking-tight ${accent ? 'text-rose-400' : 'text-white'}`}>
          {value}
        </span>
...
const PipelineStage = ({ stage, status, time, active }: PipelineStageProps) => (
  <div className={`relative flex items-center gap-3 p-3 rounded-xl transition-all duration-300 ${
    ...
    <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg ${
      ...
      status === 'active' ? 'bg-rose-500/20 text-rose-400 animate-pulse' :
    ...
    {active && (
      <div className="w-16 h-1 bg-slate-800 rounded-full overflow-hidden">
        <div className="h-full bg-gradient-to-r from-rose-500 to-purple-500 animate-pulse" style={{ width: '60%' }} />
      </div>
    )}
  </div>
);
...
const Preview3D = ({ generating }: Preview3DProps) => {
  ...
  return (
    <div className="relative aspect-square rounded-2xl bg-gradient-to-br from-slate-900 to-black overflow-hidden border border-white/5">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          {/* Cube faces */}
          <div className="absolute inset-0 border-2 border-rose-500/30 bg-rose-500/5"
               style={{ transform: 'translateZ(64px)' }} />
          <div className="absolute inset-0 border-2 border-purple-500/30 bg-purple-500/5"
      ...
      <div className="absolute bottom-3 left-3 right-3 flex justify-between">
        <div className="flex gap-1">
          {['↻', '⊕', '⊖'].map((icon, i) => (
            <button key={i} className="w-8 h-8 rounded-lg bg-black/50 border border-white/10 text-slate-400 text-xs hover:bg-white/10 hover:text-white transition-all">
              {icon}
            </button>
          ))}
        </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-slate-500 tracking-[0.3em]">3D ASSET PIPELINE</div>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex bg-white/5 rounded-xl p-1">
                  {['pipeline', 'assets', 'settings'].map(tab => (
                    <button
                      key={tab}
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              >
                <div className="p-8 text-center">
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center text-2xl transition-all ${
                    uploadHover ? 'bg-rose-500/20 text-rose-400 scale-110' : 'bg-white/5 text-slate-500'
                  }`}>
                    ↑
                  </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="text-xs uppercase tracking-[0.2em] text-slate-500 mb-4">Pipeline Status</div>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl bg-white/[0.02] border border-white/5 p-4">
                <div className="text-xs uppercase tracking-[0.2em] text-slate-500 mb-4">Generation Model</div>
              ...
              <div className="rounded-2xl bg-white/[0.02] border border-white/5 p-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-xs uppercase tracking-[0.2em] text-slate-500">Recent Assets</div>
              ...
              <div className="rounded-2xl bg-gradient-to-br from-rose-500/10 to-purple-600/10 border border-rose-500/20 p-4">
                <div className="text-xs uppercase tracking-[0.2em] text-rose-400/70 mb-3">This Week</div>
          ...
          <div className="mt-8 rounded-2xl bg-white/[0.02] border border-white/5 p-4">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-6 flex-wrap">
                <div className="text-xs uppercase tracking-[0.2em] text-slate-500">DevSkyy Integration</div>
              ...
              <div className="text-xs text-slate-500">
                2-LLM Validation: <span className="text-emerald-400">Active</span> •
