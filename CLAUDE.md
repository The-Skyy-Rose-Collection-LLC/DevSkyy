...
- **bug-284** (×2, 2026-07-23): Open redirect in admin login: callbackUrl from query string pushed unguarded af… → fix: DEFINITIVE FIX 2026-07-23: safeCallbackUrl rewritten to parse `raw` against a f…
<!-- wolf:recurring:end -->
