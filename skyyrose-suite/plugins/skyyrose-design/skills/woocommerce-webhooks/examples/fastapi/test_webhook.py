...
def generate_test_signature(payload: str, secret: str) -> str:
    ...
    """
    hash_digest = hmac.new(secret.encode("utf-8"), payload.encode("utf-8"), hashlib.sha256).digest()
...
class TestSignatureVerification:
    def test_should_verify_valid_signatures(self):
        ...
        is_valid = verify_woocommerce_webhook(payload.encode("utf-8"), signature, TEST_SECRET)
    ...
    def test_should_reject_invalid_signatures(self):
        ...
        is_valid = verify_woocommerce_webhook(
            payload.encode("utf-8"), invalid_signature, TEST_SECRET
        )
    ...
    def test_should_reject_missing_signature(self):
        ...
        is_valid = verify_woocommerce_webhook(payload.encode("utf-8"), None, TEST_SECRET)
    ...
    def test_should_reject_missing_secret(self):
        ...
        is_valid = verify_woocommerce_webhook(payload.encode("utf-8"), signature, None)
