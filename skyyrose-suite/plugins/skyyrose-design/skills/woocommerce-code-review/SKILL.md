...
**Sentence case rule:** All WooCommerce UI copy uses **sentence case** — capitalize only the first word and proper nouns. Title Case in buttons/labels/headings is a flag-level finding.

- ❌ **Title Case in UI** - Must use sentence case
