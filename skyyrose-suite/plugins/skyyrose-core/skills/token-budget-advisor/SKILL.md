...
Use these two token-estimation heuristics to calibrate your estimate (the same approach used by a context-budget tracker):

- prose: `words × 1.3 ≈ tokens`
- code-heavy or mixed/code blocks: `characters / 4 ≈ tokens`
