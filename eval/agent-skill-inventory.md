...
phase: 0
test_command: node scripts/measurement/check-agent-inventory.js  # PHASE 0.5 DELIVERABLE — script does not exist yet; to be built in Phase 0.5 alongside verify-all-grants.js. See scripts/measurement/README.md.
