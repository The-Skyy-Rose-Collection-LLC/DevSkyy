...
Usage:
    from mcp_tools.external_clients.context7 import context7_client
...
class Context7Client:
    ...
    async def get_code_examples(
        ...
        Returns:
            List of code examples with ``language``, ``code``, and ``topic`` keys
        """
        # Resolve library
        ...
        # Parse examples from docs (split on fenced code blocks)
