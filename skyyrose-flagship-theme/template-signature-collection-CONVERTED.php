...
// Enqueue Three.js r182 and assets
function skyyrose_signature_3d_enqueue() {
    // Three.js CDN (r182 from original HTML)
...
<head>
    ...
    <title>SIGNATURE Collection | <?php bloginfo( 'name' ); ?> — Luxury Runway</title>
    <?php wp_head(); ?>

    <!-- SEO Meta Tags -->
    <meta name="description" content="Experience the SIGNATURE Collection in immersive 3D. Luxury fashion pieces featuring rose gold and gold accents in an interactive glass pavilion showcase.">
    <meta name="keywords" content="signature collection, luxury fashion, 3d fashion showcase, rose gold, skyyrose">
    
    <!-- Open Graph -->
    <meta property="og:title" content="SIGNATURE Collection 3D | SkyyRose Flagship">
    <meta property="og:description" content="Experience luxury fashion in 3D. Interactive glass pavilion showcase featuring rose gold and gold signature pieces.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://skyyrose.co/signature-collection-3d/">
    <meta property="og:image" content="https://skyyrose.co/wp-content/themes/skyyrose-flagship/screenshot.png">
    
    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="SIGNATURE Collection 3D">
    <meta name="twitter:description" content="Experience luxury fashion in immersive 3D">
    <meta name="twitter:image" content="https://skyyrose.co/wp-content/themes/skyyrose-flagship/screenshot.png">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Luxury fashion collection featuring rose gold and gold pieces",
...
<div id="info">
  ...
  <div class="info-count">5 pieces — 2025</div>
</div>
...
<script type="module" src="<?php echo esc_url( get_template_directory_uri() . '/assets/js/signature-collection-3d.min.js' ); ?>"></script>
...
<div class="view-collection-cta">
  <a href="<?php echo esc_url( get_term_link( 'signature-collection', 'product_cat' ) ); ?>" class="btn-view-collection">
    <span class="icon">📱</span> View Collection
  </a>
</div>
<?php
} // End Elementor check
