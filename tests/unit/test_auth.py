...
from api.validation_models import EnhancedRegisterRequest, EnhancedLoginRequest
...
class TestEnhancedValidation:
        ...
        for weak_password in weak_passwords:
            with pytest.raises(ValueError):
                EnhancedRegisterRequest(
                    email="test@example.com", username="testuser", password=weak_password, role="api_user"
                )
    ...
    def test_username_validation(self):
        ...
        for invalid_username in invalid_usernames:
            with pytest.raises(ValueError):
                EnhancedRegisterRequest(
                    email="test@example.com", username=invalid_username, password="TestPassword123!", role="api_user"
                )
...
class TestAuthenticationAPI:
    ...
    def test_register_endpoint_weak_password(self):
        ...
        invalid_data = {"email": "test@example.com", "username": "testuser", "password": "weak", "role": "api_user"}
...
class TestSecurityLogging:
    ...
    def test_security_event_logging(self):
        ...
        with patch("logging_config.security_logger.log_authentication_event") as mock_log:
