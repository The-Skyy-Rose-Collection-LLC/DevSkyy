...
class TestMeshyClient:
    ...
    def mock_api_key(self, monkeypatch):
        """Set mock API key."""
        monkeypatch.setenv("MESHY_API_KEY", "test-api-key")

    @pytest.mark.asyncio
    async def test_meshy_client_initialization(self, mock_api_key):
    ...
    @pytest.mark.asyncio
    async def test_meshy_client_context_manager(self, mock_api_key):
    ...
    @pytest.mark.asyncio
    async def test_meshy_rate_limiting_semaphore(self, mock_api_key):
    ...
    def test_meshy_client_requires_api_key(self, monkeypatch):
...
class TestRateLimitingPatterns:
    ...
    @pytest.mark.asyncio
    async def test_semaphore_concurrency_limit(self, monkeypatch):
...
class TestAsyncPatterns:
    ...
    @pytest.mark.asyncio
    async def test_no_blocking_calls_in_meshy(self, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_context_manager_cleanup(self, monkeypatch):
