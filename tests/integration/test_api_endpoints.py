...
class TestAgentEndpoints:
    ...
    def test_agent_execution_validation(self):
        ...
        response = self.client.post(
            "/api/v1/agents/content_generator/execute", json=execution_data, headers=self.headers
        )
    ...
    def test_agent_execution_invalid_data(self):
        ...
        response = self.client.post("/api/v1/agents/content_generator/execute", json=invalid_data, headers=self.headers)
