...
class TestGDPRExport:
    ...
    async def test_export_requires_authentication(self, client):
        ...
        response = await client.post(
            "/api/v1/gdpr/export", json={"format": "json", "categories": ["identity"]}
        )
...
class TestGDPRAudit:
    ...
    async def test_admin_can_view_requests(self, client, admin_headers):
        ...
        response = await client.get("/api/v1/gdpr/requests", headers=admin_headers)
    ...
    async def test_non_admin_cannot_view_requests(self, client, auth_headers):
        ...
        response = await client.get("/api/v1/gdpr/requests", headers=auth_headers)
...
class TestConsent:
    ...
    async def test_record_consent(self, client, auth_headers):
        ...
        response = await client.post(
            "/api/v1/gdpr/consent",
            headers=auth_headers,
            params={"purpose": "marketing_emails", "granted": True},
        )
    ...
    async def test_get_user_consents(self, client, auth_headers):
        ...
        # Then retrieve
        response = await client.get("/api/v1/gdpr/consent", headers=auth_headers)
    ...
    async def test_consent_requires_auth(self, client):
        ...
        response = await client.post(
            "/api/v1/gdpr/consent", params={"purpose": "test", "granted": True}
        )
