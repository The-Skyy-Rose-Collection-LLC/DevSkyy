...
function skyyrose2_collections() {
	return array(
		...
		'black-rose'   => array(
			...
			'hero'       => 'branding/hero/forbidden-midnight-1280w.webp',
			...
			'world'      => array(
				...
				array( 'image' => 'branding/hero/forbidden-midnight-1280w.webp', 'label' => __( 'Midnight House', 'skyyrose-flagship-2' ), 'copy' => __( 'Quiet strength, cut in silver light.', 'skyyrose-flagship-2' ) ),
