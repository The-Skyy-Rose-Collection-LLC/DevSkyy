...
( function () {
	 ...
	 *  touch this path). */
	var DRACO_DECODER_PATH = ( window.SKYY_3D_CONFIG && window.SKYY_3D_CONFIG.decoderPath )
		? window.SKYY_3D_CONFIG.decoderPath
		: SKYYROSE_ASSETS_URI_3D() + '/js/lib/draco/';
	...
	function initScene( THREE ) {
		...
		// Keep the supplied Tripo mesh untouched so its clothing UVs and
		// animation bind pose remain canonical. In the glTF runtime coordinate
		// space the authored front is viewed from +Z.
