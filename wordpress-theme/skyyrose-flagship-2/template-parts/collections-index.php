...
<section class="sr2-page-hero sr2-page-hero--collections" aria-labelledby="sr2-page-title">
	...
	<div class="sr2-page-hero__copy"><p class="sr2-eyebrow"><?php esc_html_e( 'The House', 'skyyrose-flagship-2' ); ?></p><h1 id="sr2-page-title"><?php esc_html_e( 'Every collection opens another world.', 'skyyrose-flagship-2' ); ?></h1><p><?php esc_html_e( 'One Oakland origin. Four distinct points of view. Choose the chapter that speaks in your language.', 'skyyrose-flagship-2' ); ?></p></div>
</section>
