...
<main id="primary" class="site-main skr-single" role="main" tabindex="-1">
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'skr-single__article' ); ?>>
		...
		<div class="skr-single__inner">
			...
			<!-- Post Navigation -->
			<nav class="skr-single__nav" aria-label="<?php esc_attr_e( 'Post navigation', 'skyyrose' ); ?>">
				<?php
				the_post_navigation(
					array(
						'prev_text' => '<span class="skr-single__nav-label">' . esc_html__( 'Previous', 'skyyrose' ) . '</span><span class="skr-single__nav-title">%title</span>',
						'next_text' => '<span class="skr-single__nav-label">' . esc_html__( 'Next', 'skyyrose' ) . '</span><span class="skr-single__nav-title">%title</span>',
					)
				);
				?>
			</nav>
