...
> - Source-of-truth plans: `docs/SKYYROSE_V2_MASTER_PLAN.md` §0.4 (this directory's allowed/forbidden table) and `docs/SKYYROSE_WORDPRESS_PLAN.md` §5.2 (the 9 component primitives spec lives in `template-parts/components/`)
