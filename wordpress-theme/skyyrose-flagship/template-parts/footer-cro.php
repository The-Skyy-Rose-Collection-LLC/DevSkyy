...
<div class="ft-cro-banner rv-clip-up">
	<p><?php esc_html_e( 'Limited Edition. Individually Numbered. Never Restocked.', 'skyyrose-flagship' ); ?></p>
</div>

<!-- Customer Reviews -->
<section class="ft-cro-reviews rv-clip-up" aria-label="<?php esc_attr_e( 'Customer reviews', 'skyyrose-flagship' ); ?>">
	<div class="ft-cro__container">
		<h2 class="ft-cro__heading"><?php esc_html_e( 'What Customers Say', 'skyyrose-flagship' ); ?></h2>
...
<!-- Value Props -->
<section class="ft-cro-craft rv-clip-up" aria-label="<?php esc_attr_e( 'Why SkyyRose', 'skyyrose-flagship' ); ?>">
	<div class="ft-cro__container">
		<h2 class="ft-cro__heading"><?php esc_html_e( 'Why SkyyRose', 'skyyrose-flagship' ); ?></h2>
		<p class="ft-cro__subheading"><?php esc_html_e( 'Every dollar goes into the product. No influencer budgets. No middlemen. Just quality you can feel.', 'skyyrose-flagship' ); ?></p>
...
<!-- FAQ -->
<section class="ft-cro-faq rv-clip-up" id="faq" aria-label="<?php esc_attr_e( 'Frequently asked questions', 'skyyrose-flagship' ); ?>">
	<div class="ft-cro__container">
		<h2 class="ft-cro__heading"><?php esc_html_e( 'Frequently Asked', 'skyyrose-flagship' ); ?></h2>
		<div class="ft-cro-faq__list">
			<?php
			$ft_faq = array(
				array( __( 'How does the sizing run?', 'skyyrose-flagship' ), __( 'True to size, S through 3XL. Check the size guide on any product page for exact measurements.', 'skyyrose-flagship' ) ),
				array( __( 'Is this really limited edition?', 'skyyrose-flagship' ), __( 'Yes. Every style is produced in a numbered run of 80-250 pieces. Once sold out, never restocked or reprinted.', 'skyyrose-flagship' ) ),
				array( __( 'When do pre-orders ship?', 'skyyrose-flagship' ), __( 'Pre-orders ship Spring 2026. You will receive tracking via email. We update timelines on our social channels.', 'skyyrose-flagship' ) ),
				array( __( 'What is your return policy?', 'skyyrose-flagship' ), __( '30-day return and exchange on unworn items. Contact us and we will make it right.', 'skyyrose-flagship' ) ),
				array( __( 'How does payment work for pre-orders?', 'skyyrose-flagship' ), __( 'Full payment at checkout to secure your numbered piece. Cancel any time before shipping for a full refund.', 'skyyrose-flagship' ) ),
