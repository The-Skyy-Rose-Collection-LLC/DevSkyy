...
$mobile_nav_items = array(
	array(
		'id'    => 'home',
		'label' => __( 'Home', 'skyyrose-flagship' ),
		'url'   => home_url( '/' ),
	...
	array(
		'id'    => 'search',
		'label' => __( 'Search', 'skyyrose-flagship' ),
		'url'   => home_url( '/?s=' ),
		'icon'  => '<circle cx="11" cy="11" r="7"/><path d="M21 21l-4.35-4.35"/>',
	),
	array(
		'id'    => 'cart',
		'label' => __( 'Cart', 'skyyrose-flagship' ),
	...
	array(
		'id'    => 'account',
		'label' => __( 'Account', 'skyyrose-flagship' ),
...
<nav class="mobile-nav" aria-label="<?php esc_attr_e( 'Mobile navigation', 'skyyrose-flagship' ); ?>">
		   ...
		   <?php echo $is_active ? 'aria-current="page"' : ''; ?>>
			<span class="mobile-nav__icon">
				...
				<?php if ( 'cart' === $item['id'] && $mobile_nav_cart_count > 0 ) : ?>
					<span class="mobile-nav__badge" aria-label="<?php echo esc_attr( sprintf( __( '%d items in cart', 'skyyrose-flagship' ), $mobile_nav_cart_count ) ); ?>">
