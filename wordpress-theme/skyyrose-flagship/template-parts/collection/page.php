...
<div class="col-page" data-collection="<?php echo esc_attr( $slug ); ?>">
	...
	<section class="col-newsletter rv-blur">
		...
		<form class="col-newsletter__form" aria-label="<?php esc_attr_e( 'Newsletter signup', 'skyyrose-flagship' ); ?>">
			<label class="screen-reader-text" for="<?php echo esc_attr( $c['email_id'] ); ?>"><?php esc_html_e( 'Email address', 'skyyrose-flagship' ); ?></label>
			<input type="email" id="<?php echo esc_attr( $c['email_id'] ); ?>" class="col-newsletter__input" placeholder="<?php esc_attr_e( 'Enter your email', 'skyyrose-flagship' ); ?>" required>
