...
$tabs = array(
	array(
		...
		'url'   => home_url( '/collections/signature/#experience' ),
		'icon'  => 'M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z',
	),
	array(
		'slug'  => 'black-rose',
		'label' => __( 'Black Rose', 'skyyrose' ),
		'url'   => home_url( '/collections/black-rose/#experience' ),
		'icon'  => 'M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z',
	),
	array(
		'slug'  => 'love-hurts',
		'label' => __( 'Love Hurts', 'skyyrose' ),
		'url'   => home_url( '/collections/love-hurts/#experience' ),
		'icon'  => 'M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z',
	),
	array(
		'slug'  => 'kids-capsule',
		'label' => __( 'Kids Capsule', 'skyyrose' ),
		'url'   => home_url( '/collections/kids-capsule/#experience' ),
