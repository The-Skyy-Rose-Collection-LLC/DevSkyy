 ...
 * of /collections/black-rose/ and this route 301s there (inc/redirects.php).
...
$experience = skyyrose_get_experience_config( 'black-rose' );
	...
	if ( $experience ) {
		get_template_part(
			...
			array(
				...
				'collection_url'  => home_url( '/collections/black-rose/' ),
