...
<!-- wp:heading {"level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","letterSpacing":"-0.025em"}},"textColor":"gold","fontFamily":"playfair-display"} -->
<h1 class="wp-block-heading has-gold-color has-text-color has-playfair-display-font-family" style="font-style:normal;font-weight:700;letter-spacing:-0.025em"><?php echo esc_html( $label ); ?></h1>
<!-- /wp:heading -->
