<?php
/**
 * Title: Black Rose Collection Hero
 * Slug: skyyrose/collection-hero-black-rose
...
$collection = function_exists( 'skyyrose_get_collection' ) ? skyyrose_get_collection( 'black-rose' ) : null;
$label      = $collection ? $collection['label'] : esc_html__( 'Black Rose', 'skyyrose' );
$tagline    = $collection ? $collection['tagline'] : esc_html__( 'Gothic elegance, dark romance', 'skyyrose' );
...
<!-- wp:heading {"level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","letterSpacing":"-0.025em"}},"textColor":"metallic-silver","fontFamily":"cinzel"} -->
...
<!-- wp:button {"backgroundColor":"metallic-silver","textColor":"black","style":{"border":{"radius":"4px"},"typography":{"textTransform":"uppercase","letterSpacing":"0.1em","fontStyle":"normal","fontWeight":"600"}},"fontFamily":"inter"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-black-color has-metallic-silver-background-color has-text-color has-background has-inter-font-family wp-element-button" style="border-radius:4px;font-style:normal;font-weight:600;letter-spacing:0.1em;text-transform:uppercase"><?php esc_html_e( 'Shop Black Rose', 'skyyrose' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
