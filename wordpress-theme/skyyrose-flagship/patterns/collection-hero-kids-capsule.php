<?php
/**
 * Title: Kids Capsule Collection Hero
...
<!-- wp:button {"backgroundColor":"pink","textColor":"black","style":{"border":{"radius":"4px"},"typography":{"textTransform":"uppercase","letterSpacing":"0.1em","fontStyle":"normal","fontWeight":"600"}},"fontFamily":"inter"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-black-color has-pink-background-color has-text-color has-background has-inter-font-family wp-element-button" style="border-radius:4px;font-style:normal;font-weight:600;letter-spacing:0.1em;text-transform:uppercase"><?php esc_html_e( 'Shop Kids Capsule', 'skyyrose' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
