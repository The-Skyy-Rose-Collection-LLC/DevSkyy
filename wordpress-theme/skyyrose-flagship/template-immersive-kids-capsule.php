 ...
 * of /collections/kids-capsule/ and this route 301s there (inc/redirects.php).
...
$experience = skyyrose_get_experience_config( 'kids-capsule' );
	...
	if ( $experience ) {
		get_template_part(
			...
			array(
				...
				'collection_url'  => home_url( '/collections/kids-capsule/' ),
