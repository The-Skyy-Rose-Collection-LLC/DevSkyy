...
$gateway_products = array(
	...
	array(
		...
		'collection_label' => esc_html__( 'Signature', 'skyyrose-flagship' ),
		'sizes'           => 'XS,S,M,L,XL,2XL',
		'desc'            => esc_html__( 'Sweet pastel vibes meet streetwear luxury. Cotton candy colorway with signature rose detail.', 'skyyrose-flagship' ),
	...
	array(
		...
		'collection_label' => esc_html__( 'Signature', 'skyyrose-flagship' ),
		'sizes'           => 'One Size',
		'desc'            => esc_html__( 'Classic fitted beanie with embroidered red rose. West Coast luxury meets everyday warmth.', 'skyyrose-flagship' ),
	...
	array(
		...
		'collection_label' => esc_html__( 'Signature', 'skyyrose-flagship' ),
		'sizes'           => 'One Size',
		'desc'            => esc_html__( 'Soft lavender beanie with embroidered rose detail. Signature luxury in every stitch.', 'skyyrose-flagship' ),
