 ...
 * of /collections/signature/ and this route 301s there (inc/redirects.php).
...
$experience = skyyrose_get_experience_config( 'signature' );
	...
	if ( $experience ) {
		get_template_part(
			...
			array(
				...
				'collection_url'  => home_url( '/collections/signature/' ),
