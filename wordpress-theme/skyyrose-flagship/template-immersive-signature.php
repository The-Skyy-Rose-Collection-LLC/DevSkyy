...
$rooms = array(
	...
	array(
		'name'  => esc_html__( 'The Golden Gate', 'skyyrose-flagship' ),
	...
	array(
		'name'  => esc_html__( 'The Bay Bridge', 'skyyrose-flagship' ),
		...
		'products'  => array(
			...
			skyyrose_immersive_product( 'sg-004', array(
				'left'       => '72',
				'top'        => '38',
				'prop'       => 'clothing-rack',
...
<main id="primary" class="site-main immersive-page" role="main" tabindex="-1">
	...
	get_template_part( 'template-parts/immersive-scene', null, array(
		...
		'collection_name' => __( 'Signature Collection', 'skyyrose-flagship' ),
		'world_name'      => __( 'The Golden Gate Runway', 'skyyrose-flagship' ),
