	...
	array(
		...
		'products' => array(
			...
			array(
				...
				'image'      => get_template_directory_uri() . '/assets/images/products/sg-009-sherpa-jacket.jpg',
			...
			array(
				...
				'collection' => esc_html__( 'Signature Collection', 'skyyrose-flagship' ),
				'sizes'      => 'S,M,L,XL,2XL',
				'image'      => get_template_directory_uri() . '/assets/images/products/sg-002-stay-golden-shorts.jpg',
			...
			array(
				...
				'collection' => esc_html__( 'Signature Collection', 'skyyrose-flagship' ),
				'sizes'      => 'S,M,L,XL,2XL,3XL',
				'image'      => get_template_directory_uri() . '/assets/images/products/sg-001-bay-set-tee.jpg',
			...
			array(
				...
				'collection' => esc_html__( 'Signature Collection', 'skyyrose-flagship' ),
				'sizes'      => 'S,M,L,XL,2XL,3XL',
				'image'      => get_template_directory_uri() . '/assets/images/products/sg-001-bay-set-shorts.jpg',
	...
	array(
		...
		'products' => array(
			...
			array(
				...
				'collection' => esc_html__( 'Signature Collection', 'skyyrose-flagship' ),
				'sizes'      => 'S,M,L,XL,2XL,3XL',
				'image'      => get_template_directory_uri() . '/assets/images/products/sg-003-signature-tee-orchid.jpg',
			...
			// Center marble display table — Stay Golden Tee
			array(
				'id'         => 'sg-005',
				...
				'collection' => esc_html__( 'Signature Collection', 'skyyrose-flagship' ),
				'sizes'      => 'XS,S,M,L,XL,2XL',
				'image'      => get_template_directory_uri() . '/assets/images/products/sg-005-stay-golden-tee.jpg',
			...
			array(
				...
				'collection' => esc_html__( 'Signature Collection', 'skyyrose-flagship' ),
				'sizes'      => 'One Size',
				'image'      => get_template_directory_uri() . '/assets/images/products/sg-007-signature-beanie.jpg',
			...
			array(
				...
				'collection' => esc_html__( 'Signature Collection', 'skyyrose-flagship' ),
				'sizes'      => 'S,M,L,XL,2XL',
				'image'      => get_template_directory_uri() . '/assets/images/products/sg-010-bridge-series-shorts.jpg',
