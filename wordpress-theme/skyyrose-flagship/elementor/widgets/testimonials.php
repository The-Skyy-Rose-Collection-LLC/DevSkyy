...
class SkyyRose_Testimonials_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials', 'skyyrose' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'name',
			array(
				'label'   => esc_html__( 'Name', 'skyyrose' ),
		...
		$repeater->add_control(
			...
			array(
				...
				'default' => esc_html__( 'This is the most beautiful piece I own.', 'skyyrose' ),
			)
		);
		...
		$repeater->add_control(
			'rating',
			array(
				'label'   => esc_html__( 'Rating (1-5)', 'skyyrose' ),
		...
		$repeater->add_control(
			'avatar',
			array(
				'label' => esc_html__( 'Avatar', 'skyyrose' ),
		...
		$this->add_control(
			'autoplay',
			array(
				'label'        => esc_html__( 'Auto-Play', 'skyyrose' ),
		...
		$this->add_control(
			'speed',
			array(
				'label'   => esc_html__( 'Transition Speed (ms)', 'skyyrose' ),
				'type'    => \Elementor\Controls_Manager::NUMBER,
				'min'     => 2000,
				'max'     => 10000,
				'step'    => 500,
	...
	protected function render() {
		...
		if ( empty( $testimonials ) ) {
			echo '<p class="elementor-alert">' . esc_html__( 'Add testimonials.', 'skyyrose' ) . '</p>';
			return;
		}
		?>
