...
function skyyrose_get_product_catalog() {
	...
	$catalog = array(
		...
		'br-002' => array(
			...
			'badge'             => 'Pre-Order',
			'image'             => $img . '/br-002.webp',
			'front_model_image' => $img . '/br-002-front-model.webp',
			'back_image'        => '',
			'sizes'             => 'S|M|L|XL|2XL|3XL',
			'color'             => 'Black',
			'edition_size'      => 250,
		...
		'br-004' => array(
			...
			'badge'             => 'Pre-Order',
			'image'             => $img . '/br-004.webp',
			'front_model_image' => $img . '/br-004-front-model.webp',
			'back_image'        => '',
			'sizes'             => 'S|M|L|XL|2XL|3XL',
			'color'             => 'Black',
			'edition_size'      => 250,
		...
		'br-005' => array(
			...
			'badge'             => 'Pre-Order',
			'image'             => $img . '/br-005.webp',
			'front_model_image' => $img . '/br-005-front-model.webp',
			'back_image'        => '',
			'sizes'             => 'S|M|L|XL|2XL|3XL',
			'color'             => 'Black',
			'edition_size'      => 250,
