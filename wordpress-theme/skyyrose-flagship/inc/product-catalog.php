...
function skyyrose_get_product_catalog() {
	...
	$catalog = array(
		...
		'br-008' => array(
			...
			'price'             => 115.00,
			'collection'        => 'black-rose',
			'description'       => 'Red #80 football jersey. SF 49ers inspired, alternating rose fill on numbers. Exclusive edition.',
			'badge'             => 'Pre-Order',
		...
		'br-009' => array(
			...
			'price'             => 115.00,
			'collection'        => 'black-rose',
			'description'       => 'White #32 football jersey. White numbers with black border, alternating rose fill — front: 3 has rose, back: 2 has rose. LAST OAKLAND edition.',
			'badge'             => 'Pre-Order',
		...
		'br-010' => array(
			...
			'price'             => 115.00,
			'collection'        => 'black-rose',
			'description'       => 'Basketball tank with "THE BAY" gold text. Rose circle graphic, grey/silver rose fade. Bay Area edition.',
			'badge'             => 'Pre-Order',
		...
		'br-011' => array(
			...
			'price'             => 115.00,
			'collection'        => 'black-rose',
			'description'       => 'Hooded hockey jersey in black and teal. San Jose Sharks inspired, rose crest on front. Exclusive edition.',
			'badge'             => 'Pre-Order',
