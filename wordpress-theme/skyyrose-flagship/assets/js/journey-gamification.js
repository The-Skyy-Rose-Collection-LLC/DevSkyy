...
(function () {
	...
	var PRODUCT_CATALOG = {
		'black-rose': [
			{ sku: 'br-001', name: 'BLACK Rose Crewneck',            price: '$85',  image: '', url: '/?product_id=br-001' },
			{ sku: 'br-002', name: 'BLACK Rose Joggers',             price: '$75',  image: '', url: '/?product_id=br-002' },
			{ sku: 'br-003', name: 'BLACK is Beautiful Jersey',      price: '$65',  image: '', url: '/?product_id=br-003' },
			{ sku: 'br-004', name: 'BLACK Rose Hoodie',              price: '$95',  image: '', url: '/?product_id=br-004' },
			{ sku: 'br-005', name: 'BLACK Rose Hoodie \u2014 Signature Edition', price: '$120', image: '', url: '/?product_id=br-005' },
			{ sku: 'br-006', name: 'BLACK Rose Sherpa Jacket',       price: '$295', image: '', url: '/?product_id=br-006' },
			{ sku: 'br-007', name: 'BLACK Rose \u00d7 Love Hurts Basketball Shorts', price: '$85', image: '', url: '/?product_id=br-007' },
			{ sku: 'br-008', name: "Women's BLACK Rose Hooded Dress", price: '$175', image: '', url: '/?product_id=br-008' },
		],
		'love-hurts': [
			{ sku: 'lh-001', name: 'Love Hurts Varsity Jacket', price: '$185', image: '', url: '/?product_id=lh-001' },
			{ sku: 'lh-002', name: 'Love Hurts Bomber Jacket',  price: '$165', image: '', url: '/?product_id=lh-002' },
			{ sku: 'lh-003', name: 'Love Hurts Joggers',        price: '$75',  image: '', url: '/?product_id=lh-003' },
			{ sku: 'lh-004', name: 'The Fannie Pack',           price: '$55',  image: '', url: '/?product_id=lh-004' },
			{ sku: 'lh-005', name: 'Love Hurts Basketball Shorts', price: '$65', image: '', url: '/?product_id=lh-005' },
		],
		'signature': [
			{ sku: 'sg-001', name: 'Red Rose Beanie',              price: '$35', image: '', url: '/?product_id=sg-001' },
			{ sku: 'sg-002', name: 'Lavender Rose Beanie',         price: '$35', image: '', url: '/?product_id=sg-002' },
			{ sku: 'sg-003', name: 'Cotton Candy Tee',             price: '$45', image: '', url: '/?product_id=sg-003' },
			{ sku: 'sg-004', name: 'Cotton Candy Shorts',          price: '$55', image: '', url: '/?product_id=sg-004' },
			{ sku: 'sg-005', name: 'Stay Golden Tee',              price: '$45', image: '', url: '/?product_id=sg-005' },
			{ sku: 'sg-006', name: 'Signature Hoodie',             price: '$95', image: '', url: '/?product_id=sg-006' },
			{ sku: 'sg-007', name: 'Crop Hoodie',                  price: '$85', image: '', url: '/?product_id=sg-007' },
			{ sku: 'sg-008', name: 'Signature Shorts',             price: '$55', image: '', url: '/?product_id=sg-008' },
			{ sku: 'sg-009', name: 'The Bay Set',                  price: '$140', image: '', url: '/?product_id=sg-009' },
			{ sku: 'sg-010', name: 'Original Label Tee (White)',   price: '$45', image: '', url: '/?product_id=sg-010' },
			{ sku: 'sg-011', name: 'Original Label Tee (Orchid)',  price: '$45', image: '', url: '/?product_id=sg-011' },
			{ sku: 'sg-012', name: 'Pink Smoke Crewneck',          price: '$85', image: '', url: '/?product_id=sg-012' },
		],
	};
