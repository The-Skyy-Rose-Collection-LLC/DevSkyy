...
(function () {
	...
	var PRODUCT_CATALOG = {
		'black-rose': [
			...
			{ sku: 'br-008', name: 'BLACK is Beautiful Jersey Series: 1. SF inspired', price: '$115', image: '', url: '/pre-order/#br-008' },
			{ sku: 'br-009', name: 'BLACK is Beautiful Jersey Series: 2. LAST OAKLAND', price: '$115', image: '', url: '/pre-order/#br-009' },
			{ sku: 'br-010', name: 'BLACK is Beautiful Jersey Series: 3. THE BAY', price: '$115', image: '', url: '/pre-order/#br-010' },
			{ sku: 'br-011', name: 'BLACK is Beautiful Jersey Series: 4. THE ROSE (SHARKS EDITION)', price: '$115', image: '', url: '/pre-order/#br-011' },
		],
		'love-hurts': [
		...
		'signature': [
			{ sku: 'sg-001', name: "The Bridge Series 'The Bay Bridge' Shorts", price: '$195', image: '', url: '/pre-order/#sg-001' },
			{ sku: 'sg-002', name: "The Bridge Series 'Stay Golden' Shirt",     price: '$65',  image: '', url: '/pre-order/#sg-002' },
			{ sku: 'sg-003', name: "The Bridge Series 'Stay Golden' Shorts",    price: '$65',  image: '', url: '/pre-order/#sg-003' },
