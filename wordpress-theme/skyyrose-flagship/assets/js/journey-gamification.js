...
(function () {
	...
	var PRODUCT_CATALOG = {
		'black-rose': [
			{ sku: 'br-001', name: 'BLACK Rose Crewneck',                         price: 'DRAFT', image: '', url: '/?product_id=br-001' },
			{ sku: 'br-002', name: 'BLACK Rose Joggers',                          price: '$50',   image: '', url: '/?product_id=br-002' },
			{ sku: 'br-003', name: 'BLACK is Beautiful Jersey',                   price: 'DRAFT', image: '', url: '/?product_id=br-003' },
			{ sku: 'br-004', name: 'BLACK Rose Hoodie',                           price: '$40',   image: '', url: '/?product_id=br-004' },
			{ sku: 'br-005', name: 'BLACK Rose Hoodie \u2014 Signature Edition',  price: '$65',   image: '', url: '/?product_id=br-005' },
			{ sku: 'br-006', name: 'BLACK Rose Sherpa Jacket',                    price: '$95',   image: '', url: '/?product_id=br-006' },
			{ sku: 'br-007', name: 'BLACK Rose \u00d7 Love Hurts Basketball Shorts', price: '$65', image: '', url: '/?product_id=br-007' },
			{ sku: 'br-008', name: "Women's BLACK Rose Hooded Dress",             price: 'TBD',   image: '', url: '/?product_id=br-008' },
		],
		'love-hurts': [
			{ sku: 'lh-001', name: 'The Fannie',                      price: '$70',  image: '', url: '/?product_id=lh-001' },
			{ sku: 'lh-002', name: 'Love Hurts Joggers (BLACK)',       price: '$67',  image: '', url: '/?product_id=lh-002' },
			{ sku: 'lh-002b', name: 'Love Hurts Joggers (WHITE)',      price: '$67',  image: '', url: '/?product_id=lh-002b' },
			{ sku: 'lh-003', name: 'Love Hurts Basketball Shorts',     price: '$55',  image: '', url: '/?product_id=lh-003' },
			{ sku: 'lh-004', name: 'Love Hurts Varsity Jacket',        price: 'DRAFT', image: '', url: '/?product_id=lh-004' },
		],
		'signature': [
			{ sku: 'sg-001-tee',    name: 'The Bay Set \u2014 Tee',       price: '$40',   image: '', url: '/?product_id=sg-001-tee' },
			{ sku: 'sg-001-shorts',  name: 'The Bay Set \u2014 Shorts',    price: '$50',   image: '', url: '/?product_id=sg-001-shorts' },
			{ sku: 'sg-002-tee',    name: 'Stay Golden Set \u2014 Tee',   price: '$40',   image: '', url: '/?product_id=sg-002-tee' },
			{ sku: 'sg-002-shorts',  name: 'Stay Golden Set \u2014 Shorts', price: '$50',   image: '', url: '/?product_id=sg-002-shorts' },
			{ sku: 'sg-003', name: 'The Signature Tee (Orchid)',           price: '$15',   image: '', url: '/?product_id=sg-003' },
			{ sku: 'sg-005', name: 'Stay Golden Tee',                     price: '$40',   image: '', url: '/?product_id=sg-005' },
			{ sku: 'sg-006', name: 'Mint & Lavender Hoodie',              price: '$45',   image: '', url: '/?product_id=sg-006' },
			{ sku: 'sg-007', name: 'The Signature Beanie',                price: '$25',   image: '', url: '/?product_id=sg-007' },
			{ sku: 'sg-009', name: 'The Sherpa Jacket',                   price: '$80',   image: '', url: '/?product_id=sg-009' },
			{ sku: 'sg-010', name: 'The Bridge Series Shorts',            price: '$25',   image: '', url: '/?product_id=sg-010' },
			{ sku: 'sg-011', name: 'Original Label Tee (White)',          price: 'DRAFT', image: '', url: '/?product_id=sg-011' },
			{ sku: 'sg-012', name: 'Original Label Tee (Orchid)',         price: 'DRAFT', image: '', url: '/?product_id=sg-012' },
		],
	};
