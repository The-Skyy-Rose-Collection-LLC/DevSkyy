...
**Garment type lock:** Football jersey, upper body, shoulder-padded shape. White colorway, #32 Jack Tatum tribute, Last Oakland Raiders era silver/black accents.

## Branding — exactly what IS on this product

> TODO — founder authoring required. The brand logo art is defined in
> `data/brand-logos/black-rose-logo.md`. Specify per-region technique + dimensions + colorway.
