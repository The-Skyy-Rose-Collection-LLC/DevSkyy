...
**Garment type lock:** Athletic shorts, lower body. NOT joggers (no ankle cuff), NOT swim trunks. Elastic waistband with drawstring, side pockets.

## Branding — exactly what IS on this product

> TODO — founder authoring required. The brand logo art is defined in
> `data/brand-logos/signature-logo.md`. Specify per-region technique + dimensions + colorway.
