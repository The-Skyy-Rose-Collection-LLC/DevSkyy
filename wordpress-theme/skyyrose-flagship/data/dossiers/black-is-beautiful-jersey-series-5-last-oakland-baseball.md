---
sku: br-012
name: BLACK is Beautiful Jersey Series — 5. Last Oakland (Baseball)
collection: black-rose
preorder: true
inherits_from: black-is-beautiful-jersey-series-0-baseball-classic-oakland
...
> edge, MLB Authentic Collection patch at lower-left hip, gold SR monogram at
...
- See canonical `black-is-beautiful-jersey-series-0-baseball-classic-oakland.md` Scene direction.
- **Pose:** Front view straight-on or three-quarter front-left to display the gold-edged tackle-twill wordmark with the black "A" accent; back view straight-on for the embroidered logos.
- **Setting:** Pure white studio backdrop, soft directional studio lighting from front-left, subtle natural drop shadow.
