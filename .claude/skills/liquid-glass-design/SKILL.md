...
**SCOPE: native iOS (SwiftUI/UIKit) ONLY — zero web applicability.** For web glass surfaces use the theme's existing `product-card-holo.css`/`.js` system. Do not load for WordPress/dashboard work.
