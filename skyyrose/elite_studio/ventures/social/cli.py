...
from .pipeline import MANIFEST, SocialPipeline
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="skyyrose.elite_studio.ventures.social",
        description="Social Media venture — Elite Studio.",
    )
    ...
    smoke = subparsers.add_parser("smoke", help="Run the free publisher pipeline against a SKU.")
    smoke.add_argument("--sku", default="smoke-001", help="SKU to feed the publisher.")
