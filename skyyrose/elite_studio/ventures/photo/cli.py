"""CLI for the Editorial Photography venture.
...
from .pipeline import MANIFEST, PhotoPipeline
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="skyyrose.elite_studio.ventures.photo",
        description="Editorial Photography venture — Elite Studio.",
    )
