# br-011 — BLACK is Beautiful Jersey Series: 4. The Rose (Hockey)
_Collection: black-rose_

## Branding spec (one-line)
Use the existing successful render as reference — vision pipeline produced a good first render of this SKU. Preserve the established composition.
...
## Logo placements
1. **hockey-championship-card** — position: `front_patch`, technique: `custom_hockey_patch`
   - Hockey Championship card — different visual style from NBA/NFL cards (gray ground, shield with sticks+puck, minimalist).
