...
_Collection: signature_

## Branding spec (one-line)
Lavender rose embroidered logo centered on the front. Small embroidered logo at the back of the neck.
...
## Logo placements
1. **black-roses-cloud-cluster** — position: `front_center`, technique: `embroidered`
2. **black-roses-cloud-cluster** — position: `back_of_neck`, technique: `embroidered`, size: 1.5″
   - Small neck back embroidery.

## Render scene context (dossier)
**Pose:** Front view straight-on showing the mint body + large lavender rose-cluster on center chest + ribbed crew-neck collar + ribbed cuffs + ribbed waistband. Back view straight-on shows the small lavender rose-cluster at back-yoke and the otherwise plain mint back. Three-quarter view shows the clean side seams and silhouette.
