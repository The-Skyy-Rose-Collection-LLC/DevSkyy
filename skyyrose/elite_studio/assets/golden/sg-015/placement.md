...
Premium windbreaker set (jacket + matching bottom). Branding detail TBD — provide a logo-details entry when you have the final spec.
...
## Logo placements
1. **rose-gold-rose** — position: `jacket_left_chest`, technique: `embroidered`
2. **rose-gold-rose** — position: `pants_left_thigh`, technique: `embroidered`
