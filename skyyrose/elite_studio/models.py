...
class CompositorResult:
    """Result from scene compositing pipeline."""

    success: bool = False
    provider: str = ""  # "fal", "replicate", "fal-kontext"
    model: str = ""  # "flux-fill-pro", "flux-kontext"
    error: str = ""
    scene_name: str = ""
    collection: str = ""
    output_path: str = ""
    alpha_path: str = ""
    qa_status: str = ""  # pass/warn/fail from Gemini QA
