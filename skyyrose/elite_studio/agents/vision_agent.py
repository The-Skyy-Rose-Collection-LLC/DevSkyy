"""DualVisionGate — Phase B2 stub (dual-agent rebuild pending).
...
Planned architecture (see .claude/plans/well-lets-audit-separately-humming-beacon.md):
    Agent A: Claude Opus 4.6 vision
    Agent B: Gemini 3 Pro vision
    Mode:    consensus
...
class DualVisionGate:
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            "DualVisionGate is a Phase B1 stub. See .claude/plans/"
            "well-lets-audit-separately-humming-beacon.md for the dual-agent "
            "rebuild design (consensus mode; Agent A=Claude Opus 4.6 vision, Agent B=Gemini 3 Pro vision)."
        )
