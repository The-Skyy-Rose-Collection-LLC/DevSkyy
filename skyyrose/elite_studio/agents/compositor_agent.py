"""CompositorAgent — Phase B2 stub (dual-agent rebuild pending).
...
Planned architecture (see .claude/plans/well-lets-audit-separately-humming-beacon.md):
    Agent A: FLUX Fill Pro
    Agent B: Gemini 3 Pro inpaint
    Mode:    best-of-N
...
class CompositorAgent:
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            "CompositorAgent is a Phase B1 stub. See .claude/plans/"
            "well-lets-audit-separately-humming-beacon.md for the dual-agent "
            "rebuild design (best-of-N mode; Agent A=FLUX Fill Pro, Agent B=Gemini 3 Pro inpaint)."
        )
