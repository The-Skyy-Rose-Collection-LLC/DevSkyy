"""GeneratorAgent — Phase B2 stub (dual-agent rebuild pending).
...
class GeneratorAgent:
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            "GeneratorAgent is a Phase B1 stub. See .claude/plans/"
            "well-lets-audit-separately-humming-beacon.md for the dual-agent "
            "rebuild design (best-of-N mode; Agent A=GPT-Image, Agent B=Gemini 3 Pro Image)."
        )
