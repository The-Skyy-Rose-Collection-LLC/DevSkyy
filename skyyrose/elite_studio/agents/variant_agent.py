"""VariantAgent — Phase B2 stub (dual-agent rebuild pending).
...
class VariantAgent:
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            "VariantAgent is a Phase B1 stub. See .claude/plans/"
            "well-lets-audit-separately-humming-beacon.md for the dual-agent "
            "rebuild design (best-of-N mode; Agent A=Claude Sonnet, Agent B=GPT-4o)."
        )
