...
| generate-fashion-models.js | AI fashion model images (Gemini 2.5 Flash Image) | `GEMINI_API_KEY` |
| generate-skyy-poses.js | **Skyy mascot poses in all SkyyRose products** — Stage 1: Flash vision garment analysis → Stage 2: Flash Image + Imagen 4 pose generation. Outputs to `assets/images/avatar/poses/` and builds `assets/data/garment-analysis.json` enhanced catalog | `GEMINI_API_KEY` |
...
|----|------|---|-------|------|
| #1465 | 4:40 PM | 🟣 | Mint & Lavender Set Split into Separate Products | ~564 |
| #1464 | 4:36 PM | 🟣 | Accuracy Correction Script Created for Three Product Regenerations | ~593 |
| #1462 | 4:29 PM | ✅ | BR-001 Regeneration Configured for Accuracy-First Crewneck Fix | ~692 |
| #1461 | 4:28 PM | 🟣 | Targeted Correction Script Created for Matching Sets and Colorway Variants | ~690 |
| #1457 | 3:20 PM | 🟣 | Product Catalog Expanded to 29 Products Across Four Collections | ~489 |
| #1456 | 2:40 PM | 🟣 | Generator Script Extended with 9 Missing Products and Kids Capsule Collection | ~899 |
| #1455 | 2:39 PM | ✅ | Kids Capsule Collection Added to AI Generation Pipeline | ~420 |
| #1451 | 2:21 PM | 🔵 | Enterprise Prompt Engineering System with ML Vision Integration | ~955 |
</claude-mem-context>