...
PRODUCTS = [
    ...
    dict(
        id="lh-003",
        col="love-hurts",
        files=["lh-003-product", "lh-003-product-2", "lh-003-product-3"],
    ),
    ...
    dict(
        id="sg-006",
        col="signature",
        files=["sg-006-product", "sg-006-product-2", "sg-006-product-3"],
    ),
    dict(
        id="sg-007",
        col="signature",
        files=["sg-007-product", "sg-007-product-2", "sg-007-product-3"],
    ),
...
def main():
    ...
    print("  Output: assets/images/products-ecom/{product-id}/\n")
