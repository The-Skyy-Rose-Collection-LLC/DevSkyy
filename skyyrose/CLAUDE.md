...
- Model: claude-sonnet-4-6. Rate limit: 10 req/min/IP. Body max: 64KB. Uses `[PRODUCT:id]` markers for avatar pointAt.
...
| LOVE HURTS | The Ballroom | `#8B0000` | lh-001..005 | SR-LH- |
| SIGNATURE | The Runway | `#D4AF37` | sg-001..014 | SR-SIG- |
| KIDS CAPSULE | — | `#FFB6C1` | kids-001..002 | SR-KC- |
...
| prompt-engine.js | Core prompt resolution + fingerprinting | `GEMINI_API_KEY` |
| prompt-studio.js | CLI: prompt management, versioning, audit | `GEMINI_API_KEY` |
...
|----|------|---|-------|------|
| #1359 | 6:13 AM | ✅ | Package Manager Overrides Cross-Compatibility | ~420 |
</claude-mem-context>