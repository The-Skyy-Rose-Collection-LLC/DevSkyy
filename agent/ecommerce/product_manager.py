...
try:  # Optional dependency for generative descriptions
    from anthropic import Anthropic  # type: ignore[import-not-found]
except ImportError:  # pragma: no cover - allow running without Anthropics SDK
...
class ProductManager:
    ...
    def __init__(self, api_key: Optional[str] = None):
        self.anthropic = Anthropic(api_key=api_key) if api_key and Anthropic else None
