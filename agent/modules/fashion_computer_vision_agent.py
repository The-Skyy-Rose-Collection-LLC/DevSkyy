...
class FashionComputerVisionAgent:
    ...
    def __init__(self):
        ...
        self.fabric_types = {
            ...
            "leather": {
                "characteristics": ["durable", "structured", "luxury", "aged_beautifully"],
                "visual_cues": ["grain_pattern", "natural_variations", "sheen"],
            },
            "linen": {
                "characteristics": ["breathable", "natural", "wrinkles_easily", "casual_luxury"],
    ...
    async def _analyze_fabric(self, image: Image.Image) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "primary_fabric": fabric_predictions[0]
                if fabric_predictions
                else "unknown",
                "fabric_confidence": fabric_predictions[1] if fabric_predictions else 0,
                "alternative_fabrics": fabric_predictions[2:]
                if len(fabric_predictions) > 2
                else [],
    ...
    async def _analyze_garment_cut(self, image: Image.Image) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"cut_type": "unknown", "message": "Could not detect garment outline"}
...
Provide detailed, expert fashion analysis.""",
    ...
    def _determine_luxury_tier(
        self, fabric: Dict, quality: Dict
    ) -> str:
        """
    ...
    def _estimate_value_range(
        self, fabric: Dict, quality: Dict, style: Dict
    ) -> str:
        """
