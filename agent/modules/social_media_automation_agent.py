...
class SocialMediaAutomationAgent:
    ...
    def __init__(self):
        ...
        self.platforms = {
            "instagram": {
                ...
                "content_types": ["feed_post", "story", "reel", "igtv", "shopping_post"],
                "hashtag_limit": 30,
                "character_limit": 2200,
                "best_practices": ["high_quality_visuals", "luxury_aesthetics", "fashion_forward_content"],
            },
            "facebook": {
                "name": "Facebook",
                "icon": "📘",
            ...
            "twitter": {
                ...
                "character_limit": 280,
                "best_practices": ["trending_hashtags", "real_time_engagement", "luxury_lifestyle_content"],
            },
            "tiktok": {
                "name": "TikTok",
                "icon": "📱",
            ...
            "pinterest": {
                ...
                "best_practices": ["seasonal_boards", "outfit_inspiration", "luxury_lifestyle"],
            },
            "linkedin": {
                "name": "LinkedIn",
                "icon": "💼",
        ...
        self.content_strategies = {
            "brand_storytelling": {
                "themes": ["heritage", "craftsmanship", "exclusivity", "sustainability"],
    ...
    def _generate_hashtag_strategy(self, brand_focus: str) -> Dict[str, Any]:
        ...
        luxury_fashion_hashtags = {
            "brand_hashtags": ["#LuxuryFashion", "#DesignerWear", "#HighFashion", "#LuxuryLifestyle"],
            "product_hashtags": ["#LuxuryDresses", "#DesignerAccessories", "#PremiumJewelry", "#CoutureStyle"],
            "lifestyle_hashtags": ["#LuxuryLiving", "#Elegance", "#Sophistication", "#ExclusiveStyle"],
        ...
        return {
            ...
            "optimal_count_per_platform": {"instagram": 25, "twitter": 3, "linkedin": 5, "tiktok": 8},
