...
<body>
    ...
    async def track_event(self, test_id: str, variant_id: str, event_type: str, data: Optional[Dict] = None) -> bool:
        """
    ...
    def _get_similar_cta(self, winning_cta: str) -> str:
        ...
        similar_ctas = {
            ...
            "Discover Collection": ["Explore Collection", "View Collection", "See Collection"],
