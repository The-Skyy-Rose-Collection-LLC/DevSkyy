...
class AgentRegistry:
    ...
    def __init__(self):
        ...
        self.dependency_map = {
            ...
            "social_media": ["ecommerce", "claude_sonnet"],  # Social needs products and content generation
            "email": ["ecommerce", "claude_sonnet"],  # Email needs customer data and templates
    ...
    async def _register_discovered_agent(self, agent_info: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            success = await orchestrator.register_agent(
                agent=agent_instance, capabilities=capabilities, dependencies=dependencies, priority=priority
            )
