        ...
        for todo_id, todo in list(self.todos.items()):
            if todo.status == Status.OPEN:
                ...
                try:
                    ...
                    print(f"Error checking TODO {todo_id}: {e}")
...
def main():
    ...
    if args.command == "scan":
        ...
        print(f"Discovered {len(discovered)} TODO items")
        
        for todo in discovered:
            tracker.add_todo(todo)
        
        print(f"Added {len(discovered)} new TODO items to tracking system")
    
    elif args.command == "sync":
        print("Synchronizing TODO tracking with codebase...")
        stats = tracker.sync_with_codebase()
        print(f"Sync complete:")
        print(f"  New TODOs: {stats['new_todos']}")
        print(f"  Completed TODOs: {stats['completed_todos']}")
        ...
        for todo in todos:
            print(f"  [{todo.priority.value.upper()}] {todo.title}")
