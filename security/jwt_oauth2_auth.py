...
class JWTConfig:
    ...
    refresh_secret_key: str = field(default_factory=lambda: os.getenv(
...
class TokenPayload:
    ...
    family_id: Optional[str] = None   # Token family for rotation tracking
...
class TokenManager:
    ...
    def is_account_locked(self, user_id: str) -> Tuple[bool, Optional[datetime]]:
...
@auth_router.get("/protected-admin", dependencies=[Depends(RoleChecker([UserRole.ADMIN, UserRole.SUPER_ADMIN]))])
