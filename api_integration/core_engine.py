...
from api_integration.discovery_engine import APIEndpoint, APICategory, api_discovery_engine
...
class APIGateway:
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            open_circuits = [
                api_id for api_id, cb in self.circuit_breakers.items()
